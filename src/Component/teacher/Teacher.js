...
import { faHome, faUsers, faChalkboardTeacher, faUser,faPlus } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div className='wrapper'>
      <div className='padding-all'>
          ...
          <div className='body'>
            body
            <div className="plushIcon" onClick={() => handleNavigation(`/SignUp?userType=teacher`)}>
